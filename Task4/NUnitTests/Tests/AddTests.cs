...
namespace NUnitTests.Tests
{
    ...
    public class AddTests
    {
        ...
        public void TestForIntValues(int firstValue, int secondValue)
        {
            ...
            var actualReault = TestContext.Calculator.Add(firstValue, secondValue);
        ...
        {
            Assert.Catch<NotFiniteNumberException>(() => TestContext.Calculator.Add(firstValue, secondValue), "Add method don't throw exception with bad string values");
        }
    }
}
